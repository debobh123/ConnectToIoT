    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (state.getConnectionState())
        {
            case Disconnected:
                ...
                connStateIcon.setImageResource(R.drawable.baseline_wifi_24_off);
                connStateIcon.setVisibility(View.VISIBLE);
                break;
            case Idle:
                sendingFilesLabel.setVisibility(View.GONE);
                receivingFilesLabel.setVisibility(View.GONE);
                connStateIcon.setImageResource(R.drawable.baseline_wifi_24_on);
                connStateIcon.setVisibility(View.VISIBLE);
                break;
            case Receiving:
                sendingFilesLabel.setVisibility(View.GONE);
                receivingFilesLabel.setVisibility(View.VISIBLE);
                connStateIcon.setImageResource(R.drawable.baseline_send_receive_24);
                connStateIcon.setVisibility(View.VISIBLE);
                break;
            case Sending:
