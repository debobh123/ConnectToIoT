...
public class IoTHUBClient {
    ...
    private String GetDeviceAccessKey(String deviceId) throws IllegalArgumentException {
        try {
            ...
            Logger.d("com.sandvik.databearerdev.IoTHUBClient:", "GetDeviceAccessKey: deviceId=" + deviceId + " MD5=" + digestHex);
            // base64 encode the MD5 hex.
            String keyBase64 = Base64.encodeBase64StringUnChunked(digestHex.getBytes("UTF-8"));
            Logger.d("com.sandvik.databearerdev.IoTHUBClient:", "GetDeviceAccessKey: return " + keyBase64 + " for device " + deviceId);
            return keyBase64;
