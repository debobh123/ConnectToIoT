package com.sandvik.databearerdev.util;
...
public class Logger {
    ...
    {
        String logFolder = AppSettings.getChrootDirAsString() + LOGS_FOLDER;   //change here
    ...
    private static void clearOldLogs(int howManyWeKeep)
    {
        ...
        {
            Log.d("Logger", "Deleting old log file: " + files[i].getName());
            files[i].delete();
        }
        scanLogs();
    }
